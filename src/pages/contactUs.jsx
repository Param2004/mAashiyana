    ...
    <div className="bg-white py-16 px-4 overflow-hidden sm:px-6 lg:px-8 lg:py-24">
      <div className="relative max-w-xl mx-auto">
        ...
        <div className="text-center">
          <h2 className="text-4xl font-bold tracking-tight text-yellow-600 sm:text-4xl">Get in Touch</h2>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="py-3 px-4 block w-full shadow-sm focus:border-yellow-600 border-gray-300 rounded-md"
                />
              </div>
            </div>
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="py-3 px-4 block w-full shadow-sm focus:ring-yellow-500 border-gray-300 rounded-md"
                />
              </div>
            </div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 flex items-center">
                  ...
                  <select
                    id="country"
                    name="country"
                    className="h-full py-0 pl-4 pr-8 border-transparent bg-transparent text-gray-500 focus:ring-yellow-500 focus:border-yellow-500 rounded-md"
                  >
                    <option>IN</option>
                    <option>US</option>
                    <option>EU</option>
